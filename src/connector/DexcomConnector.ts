import { ConnectorInterface, Response, Tendency, TendencyType } from './ConnectorInterface.js';
...
export class DexcomConnector implements ConnectorInterface {
  ...
  constructor(private readonly username: string, private readonly password: string, private readonly server: 'EU' | 'US' ) {
